...
/**
 * 代码复制与[org.jetbrains.kotlin.idea.actions.JavaToKotlinAction]
 * 修改部分逻辑，不生成同名kotlin文件
 * 不进行其它额外检测externalCodeProcessing
 *
 */
class JavaToKotlinAction {
    object Handler {
        ...
        fun convertFiles(
            ...
            fun convertWithStatistics() {
                ...
                J2KFusCollector.log(ConversionType.FILES, false/*j2kKind == K1_NEW*/, conversionTime, linesCount, javaFiles.size)
            }
